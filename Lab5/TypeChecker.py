...
class TypeChecker(NodeVisitor):
    ...
    def visit_ValueString(self, node: AST.ValueString):
        return 'str'
    ...
    def visit_Assignment(self, node: AST.Assignment):
        ...
        if node.op == '=':
            ...
            if (var_type, value_type) in operations_return_type_check[node.op]:
                assign_type = operations_return_type_check[node.op][(var_type, value_type)]
                return assign_type
            else:
